...
func test_FindUserAgreements(t *testing.T) {
	var err error
	var statusCode int
	var resp []byte
	params := map[string]interface{}{}
...
func test_FindUserArchivedAgreements(t *testing.T) {
	var err error
	var statusCode int
	var resp []byte
	params := map[string]interface{}{}
	...
	//
	params["id"] = "invalidid"
	resp, _, statusCode = FindUserArchivedAgreements(params, []byte(""))
	var respArray []map[string]interface{}
	err = json.Unmarshal(resp, &respArray)
	if err != nil {
		t.Errorf("error parsing json: %s", err.Error())
	...
	clientID, _ := uuid.NewV4()
	params = map[string]interface{}{}
	agrmnt1 := new(models.Agreement)
	agrmnt1.Archived = true
	agrmnt1.Final = true
	agrmnt1.FreelancerID = clientID.String()
	agrmnt2 := new(models.Agreement)
	agrmnt2.Archived = true
	agrmnt2.Final = true
	agrmnt2.ClientID = clientID.String()
	jsonAgrmnt1, _ := json.Marshal(agrmnt1)
	jsonAgrmnt2, _ := json.Marshal(agrmnt2)
	CreateAgreement(params, jsonAgrmnt1)
	CreateAgreement(params, jsonAgrmnt2)
	params["id"] = clientID.String()
	resp, _, statusCode = FindUserArchivedAgreements(params, []byte(""))
	respArray = []map[string]interface{}{}
	err = json.Unmarshal(resp, &respArray)
...
func test_UpdateAgreement(t *testing.T) {
